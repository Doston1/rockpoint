...
router.get('/api-keys/permissions', asyncHandler(async (req: Request, res: Response) => {
  const availablePermissions = [
    ...
    { name: 'transactions:write', description: 'Create and update transactions' },
    { name: 'sync:read', description: 'Read synchronization status' },
    { name: 'sync:write', description: 'Execute synchronization operations' },
    { name: 'reports:read', description: 'Read reports data' },
