...
INSERT INTO products (sku, name, name_en, name_ru, name_uz, barcode, price, cost, quantity_in_stock, low_stock_threshold, category_id, brand, description, description_en, description_ru, description_uz, unit_of_measure, tax_rate, image_paths, has_image, is_active) 
VALUES 
    -- Beverages Category
    ('COCA-500ML', 'Coca Cola 500ml', 'Coca Cola 500ml', 'Кока-Кола 500мл', 'Koka-Kola 500ml', '123456789012', 2.50, 1.20, 150, 20, (SELECT id FROM categories WHERE key = 'beverages'), 'Coca Cola', 'Classic Coca Cola 500ml bottle', 'Classic Coca Cola 500ml bottle', 'Классическая Кока-Кола бутылка 500мл', 'Klassik Koka-Kola shisha 500ml', 'bottle', 0.1200, '{"thumbnail": "/images/products/coca-500ml-thumb.jpg", "medium": "/images/products/coca-500ml-med.jpg", "large": "/images/products/coca-500ml-large.jpg"}'::jsonb, true, true),
    ('PEPSI-500ML', 'Pepsi 500ml', 'Pepsi 500ml', 'Пепси 500мл', 'Pepsi 500ml', '123456789013', 2.45, 1.18, 120, 20, (SELECT id FROM categories WHERE key = 'beverages'), 'Pepsi', 'Pepsi Cola 500ml bottle', 'Pepsi Cola 500ml bottle', 'Пепси Кола бутылка 500мл', 'Pepsi Kola shisha 500ml', 'bottle', 0.1200, '{"thumbnail": "/images/products/pepsi-500ml-thumb.jpg", "medium": "/images/products/pepsi-500ml-med.jpg", "large": "/images/products/pepsi-500ml-large.jpg"}'::jsonb, true, true),
    ('WATER-1L', 'Water 1L', 'Water 1L', 'Вода 1Л', 'Suv 1L', '123456789014', 1.00, 0.40, 200, 30, (SELECT id FROM categories WHERE key = 'beverages'), 'Pure Life', 'Pure drinking water 1 liter', 'Pure drinking water 1 liter', 'Чистая питьевая вода 1 литр', 'Toza ichimlik suvi 1 litr', 'bottle', 0.0000, NULL, false, true),
    ('OJ-1L', 'Orange Juice 1L', 'Orange Juice 1L', 'Апельсиновый сок 1Л', 'Apelsin sharbati 1L', '123456789015', 3.99, 2.10, 50, 10, (SELECT id FROM categories WHERE key = 'beverages'), 'Tropicana', 'Fresh orange juice 1 liter', 'Fresh orange juice 1 liter', 'Свежий апельсиновый сок 1 литр', 'Yangi apelsin sharbati 1 litr', 'carton', 0.1200, NULL, false, true),
    ('AJ-1L', 'Apple Juice 1L', 'Apple Juice 1L', 'Яблочный сок 1Л', 'Olma sharbati 1L', '123456789016', 3.75, 2.00, 45, 10, (SELECT id FROM categories WHERE key = 'beverages'), 'Minute Maid', 'Fresh apple juice 1 liter', 'Fresh apple juice 1 liter', 'Свежий яблочный сок 1 литр', 'Yangi olma sharbati 1 litr', 'carton', 0.1200, NULL, false, true),
    ('ENERGY-250ML', 'Energy Drink 250ml', 'Energy Drink 250ml', 'Энергетик 250мл', 'Energetik ichimlik 250ml', '123456789017', 2.99, 1.50, 80, 15, (SELECT id FROM categories WHERE key = 'beverages'), 'Red Bull', 'Energy drink 250ml can', 'Energy drink 250ml can', 'Энергетический напиток банка 250мл', 'Energetik ichimlik banka 250ml', 'can', 0.1200, NULL, false, true),
    
    -- Snacks Category
    ('CHIPS-ORG', 'Chips Original', 'Chips Original', 'Чипсы оригинальные', 'Chiplar original', '223456789012', 3.50, 1.75, 80, 15, (SELECT id FROM categories WHERE key = 'snacks'), 'Lays', 'Original flavor potato chips', 'Original flavor potato chips', 'Картофельные чипсы оригинальный вкус', 'Kartoshka chipslari original ta''mi', 'bag', 0.1200, NULL, false, true),
    ('SNICKERS', 'Chocolate Bar', 'Chocolate Bar', 'Шоколадный батончик', 'Shokolad batoni', '223456789013', 2.99, 1.50, 60, 10, (SELECT id FROM categories WHERE key = 'snacks'), 'Snickers', 'Milk chocolate with peanuts', 'Milk chocolate with peanuts', 'Молочный шоколад с арахисом', 'Sut shokoladi yong''oqli', 'bar', 0.1200, NULL, false, true),
    ('OREO-PACK', 'Cookies Pack', 'Cookies Pack', 'Упаковка печенья', 'Pechene paketi', '223456789014', 4.50, 2.25, 40, 8, (SELECT id FROM categories WHERE key = 'snacks'), 'Oreo', 'Chocolate sandwich cookies', 'Chocolate sandwich cookies', 'Шоколадное сэндвич-печенье', 'Shokoladli sendvich pechene', 'pack', 0.1200, NULL, false, true),
    ('PEANUTS', 'Peanuts Roasted', 'Peanuts Roasted', 'Жареный арахис', 'Qovurilgan yong''oq', '223456789015', 2.25, 1.10, 35, 5, (SELECT id FROM categories WHERE key = 'snacks'), 'Planters', 'Salted roasted peanuts', 'Salted roasted peanuts', 'Соленый жареный арахис', 'Tuzli qovurilgan yong''oq', 'bag', 0.1200, NULL, false, true),
    ('POPCORN', 'Popcorn', 'Popcorn', 'Попкорн', 'Popkorn', '223456789016', 1.99, 0.90, 25, 5, (SELECT id FROM categories WHERE key = 'snacks'), 'Pop Secret', 'Microwave popcorn butter flavor', 'Microwave popcorn butter flavor', 'Попкорн в микроволновке со вкусом масла', 'Mikrotolqinli popkorn sariyog'' ta''mi', 'box', 0.1200, NULL, false, true),
    ('GUMMY-BEARS', 'Gummy Bears', 'Gummy Bears', 'Мишки Гамми', 'Rezina ayiqchalar', '223456789017', 3.25, 1.60, 30, 6, (SELECT id FROM categories WHERE key = 'snacks'), 'Haribo', 'Fruit gummy bears candy', 'Fruit gummy bears candy', 'Фруктовые мишки Гамми', 'Mevali rezina ayiqchalar', 'bag', 0.1200, NULL, false, true),
    
    -- Dairy Category  
    ('MILK-1L', 'Milk 1L', 'Milk 1L', 'Молоко 1Л', 'Sut 1L', '323456789012', 3.25, 2.00, 75, 12, (SELECT id FROM categories WHERE key = 'dairy'), 'Farm Fresh', 'Whole milk 1 liter', 'Whole milk 1 liter', 'Цельное молоко 1 литр', 'To''liq sut 1 litr', 'carton', 0.0000, NULL, false, true),
    ('YOGURT-PLAIN', 'Yogurt Vanilla', 'Yogurt Vanilla', 'Ванильный йогурт', 'Vanil yogurt', '323456789013', 1.99, 0.95, 45, 8, (SELECT id FROM categories WHERE key = 'dairy'), 'Danone', 'Vanilla flavored yogurt', 'Vanilla flavored yogurt', 'Ванильный йогурт', 'Vanil ta''midagi yogurt', 'cup', 0.1200, NULL, false, true),
    ('CHEESE-SLICE', 'Cheese Slices', 'Cheese Slices', 'Сырные ломтики', 'Pishloq bo''laklari', '323456789014', 4.99, 2.50, 30, 5, (SELECT id FROM categories WHERE key = 'dairy'), 'Kraft', 'American cheese slices', 'American cheese slices', 'Американские сырные ломтики', 'Amerika pishloq bo''laklari', 'pack', 0.1200, NULL, false, true),
    ('BUTTER-500G', 'Butter 500g', 'Butter 500g', 'Масло 500г', 'Sariyog'' 500g', '323456789015', 5.50, 3.20, 25, 3, (SELECT id FROM categories WHERE key = 'dairy'), 'Land O Lakes', 'Salted butter 500 grams', 'Salted butter 500 grams', 'Соленое масло 500 грамм', 'Tuzli sariyog'' 500 gramm', 'pack', 0.1200, NULL, false, true),
    ('YOGURT-GREEK', 'Greek Yogurt', 'Greek Yogurt', 'Греческий йогурт', 'Grek yogurti', '323456789016', 2.49, 1.25, 35, 6, (SELECT id FROM categories WHERE key = 'dairy'), 'Chobani', 'Plain Greek yogurt', 'Plain Greek yogurt', 'Простой греческий йогурт', 'Oddiy grek yogurti', 'cup', 0.1200, NULL, false, true),
    ('CREAM-CHEESE', 'Cream Cheese', 'Cream Cheese', 'Сливочный сыр', 'Qaymoqli pishloq', '323456789017', 3.99, 2.10, 20, 4, (SELECT id FROM categories WHERE key = 'dairy'), 'Philadelphia', 'Original cream cheese', 'Original cream cheese', 'Оригинальный сливочный сыр', 'Original qaymoqli pishloq', 'pack', 0.1200, NULL, false, true),    -- Bakery Category
    ('BREAD-WHITE', 'White Bread', 'White Bread', 'Белый хлеб', 'Oq non', '423456789012', 2.75, 1.30, 40, 8, (SELECT id FROM categories WHERE key = 'bakery'), 'Wonder', 'Sliced white bread loaf', 'Sliced white bread loaf', 'Нарезанная буханка белого хлеба', 'To''g''ralgan oq non boshli', 'loaf', 0.0000, NULL, false, true),
    ('BREAD-WHEAT', 'Whole Wheat Bread', 'Whole Wheat Bread', 'Цельнозерновой хлеб', 'To''liq bug''doy noni', '423456789013', 3.25, 1.60, 35, 6, (SELECT id FROM categories WHERE key = 'bakery'), 'Pepperidge Farm', 'Whole wheat bread loaf', 'Whole wheat bread loaf', 'Буханка цельнозернового хлеба', 'To''liq bug''doy noni boshli', 'loaf', 0.0000, NULL, false, true),
    ('CROISSANT', 'Croissant', 'Croissant', 'Круассан', 'Kruassan', '423456789014', 1.50, 0.75, 20, 4, (SELECT id FROM categories WHERE key = 'bakery'), 'Fresh Baked', 'Buttery croissant pastry', 'Buttery croissant pastry', 'Масляное тесто круассан', 'Sariyog''li kruassan xamiri', 'piece', 0.1200, NULL, false, true),
    ('BAGELS-6', 'Bagels 6-pack', 'Bagels 6-pack', 'Бейглы 6 штук', 'Begellar 6 ta', '423456789015', 4.99, 2.40, 15, 3, (SELECT id FROM categories WHERE key = 'bakery'), 'Thomas', 'Everything bagels 6 pack', 'Everything bagels 6 pack', 'Бейглы со всем 6 штук', 'Hamma narsali begellar 6 ta', 'pack', 0.1200, NULL, false, true),
    ('DONUTS-12', 'Donuts 12-pack', 'Donuts 12-pack', 'Пончики 12 штук', 'Donutlar 12 ta', '423456789016', 6.99, 3.50, 10, 2, (SELECT id FROM categories WHERE key = 'bakery'), 'Krispy Kreme', 'Glazed donuts 12 pack', 'Glazed donuts 12 pack', 'Глазированные пончики 12 штук', 'Sirlangan donutlar 12 ta', 'pack', 0.1200, NULL, false, true),
    ('MUFFINS-4', 'Muffins 4-pack', 'Muffins 4-pack', 'Кексы 4 штуки', 'Kekslar 4 ta', '423456789017', 3.99, 2.00, 18, 3, (SELECT id FROM categories WHERE key = 'bakery'), 'Fresh Baked', 'Blueberry muffins 4 pack', 'Blueberry muffins 4 pack', 'Черничные кексы 4 штуки', 'Ko''k rezavorang kekslar 4 ta', 'pack', 0.1200, NULL, false, true),
    
    -- Personal Care Category
    ('TOOTHPASTE-COL', 'Toothpaste', 'Toothpaste', 'Зубная паста', 'Tish pastasi', '523456789012', 3.99, 2.10, 50, 8, (SELECT id FROM categories WHERE key = 'personal_care'), 'Colgate', 'Whitening toothpaste', 'Whitening toothpaste', 'Отбеливающая зубная паста', 'Oqartiruvchi tish pastasi', 'tube', 0.1200, NULL, false, true),
    ('SHAMPOO-400ML', 'Shampoo 400ml', 'Shampoo 400ml', 'Шампунь 400мл', 'Shampun 400ml', '523456789013', 6.99, 3.50, 30, 5, (SELECT id FROM categories WHERE key = 'personal_care'), 'Head & Shoulders', 'Dandruff shampoo 400ml', 'Dandruff shampoo 400ml', 'Шампунь от перхоти 400мл', 'Kepak qarshi shampun 400ml', 'bottle', 0.1200, NULL, false, true),
    ('SOAP-BAR', 'Soap Bar', 'Soap Bar', 'Мыло', 'Sovun', '523456789014', 1.99, 0.80, 60, 10, (SELECT id FROM categories WHERE key = 'personal_care'), 'Dove', 'Moisturizing soap bar', 'Moisturizing soap bar', 'Увлажняющее мыло', 'Namlovchi sovun', 'bar', 0.1200, NULL, false, true),
    ('DEODORANT-AXE', 'Deodorant', 'Deodorant', 'Дезодорант', 'Dezodorant', '523456789015', 4.50, 2.25, 25, 5, (SELECT id FROM categories WHERE key = 'personal_care'), 'Axe', 'Body spray deodorant', 'Body spray deodorant', 'Спрей-дезодорант для тела', 'Tana uchun sprey dezodorant', 'bottle', 0.1200, NULL, false, true),
    ('RAZORS-3', 'Razors 3-pack', 'Razors 3-pack', 'Бритвы 3 штуки', 'Usturalar 3 ta', '523456789016', 7.99, 4.00, 20, 4, (SELECT id FROM categories WHERE key = 'personal_care'), 'Gillette', 'Disposable razors 3 pack', 'Disposable razors 3 pack', 'Одноразовые бритвы 3 штуки', 'Bir martalik usturalar 3 ta', 'pack', 0.1200, NULL, false, true),
    ('SANITIZER-8OZ', 'Hand Sanitizer', 'Hand Sanitizer', 'Дезинфектор для рук', 'Qo''l dezinfektori', '523456789017', 2.99, 1.50, 40, 8, (SELECT id FROM categories WHERE key = 'personal_care'), 'Purell', 'Hand sanitizer gel 8oz', 'Hand sanitizer gel 8oz', 'Гель дезинфектор для рук 8 унций', 'Qo''l dezinfektor geli 8 untsiya', 'bottle', 0.1200, NULL, false, true),
    
    -- Household Category
    ('PAPER-TOWELS', 'Paper Towels', 'Paper Towels', 'Бумажные полотенца', 'Qog''oz sochiqlar', '623456789012', 5.99, 3.00, 40, 6, (SELECT id FROM categories WHERE key = 'household'), 'Bounty', 'Absorbent paper towels', 'Absorbent paper towels', 'Впитывающие бумажные полотенца', 'Shimuvchi qog''oz sochiqlar', 'roll', 0.1200, NULL, false, true),
    ('TOILET-PAPER', 'Toilet Paper 12-pack', 'Toilet Paper 12-pack', 'Туалетная бумага 12 рулонов', 'Hojatxona qog''ozi 12 ta', '623456789013', 12.99, 6.50, 20, 3, (SELECT id FROM categories WHERE key = 'household'), 'Charmin', 'Ultra soft toilet paper', 'Ultra soft toilet paper', 'Ультра мягкая туалетная бумага', 'Ultra yumshoq hojatxona qog''ozi', 'pack', 0.1200, NULL, false, true),
    ('DISH-SOAP', 'Dish Soap', 'Dish Soap', 'Средство для мытья посуды', 'Idish yuvish vositasi', '623456789014', 2.99, 1.40, 35, 6, (SELECT id FROM categories WHERE key = 'household'), 'Dawn', 'Grease-fighting dish soap', 'Grease-fighting dish soap', 'Средство против жира для посуды', 'Yog''ga qarshi idish sovuni', 'bottle', 0.1200, NULL, false, true),
    ('DETERGENT-TIDE', 'Laundry Detergent', 'Laundry Detergent', 'Стиральный порошок', 'Kir yuvish kukuni', '623456789015', 8.99, 4.50, 18, 3, (SELECT id FROM categories WHERE key = 'household'), 'Tide', 'High efficiency detergent', 'High efficiency detergent', 'Высокоэффективный стиральный порошок', 'Yuqori samarali kir yuvish kukuni', 'box', 0.1200, NULL, false, true),
    ('TRASH-BAGS', 'Trash Bags 30-pack', 'Trash Bags 30-pack', 'Мусорные мешки 30 штук', 'Axlat xaltalari 30 ta', '623456789016', 4.99, 2.50, 25, 5, (SELECT id FROM categories WHERE key = 'household'), 'Glad', 'Kitchen trash bags 30 pack', 'Kitchen trash bags 30 pack', 'Кухонные мусорные мешки 30 штук', 'Oshxona axlat xaltalari 30 ta', 'pack', 0.1200, NULL, false, true),
    ('CLEANER-SPRAY', 'All-Purpose Cleaner', 'All-Purpose Cleaner', 'Универсальное чистящее средство', 'Universal tozalovchi vosita', '623456789017', 3.49, 1.75, 30, 5, (SELECT id FROM categories WHERE key = 'household'), 'Mr. Clean', 'Multi-surface cleaner spray', 'Multi-surface cleaner spray', 'Спрей для многих поверхностей', 'Ko''p sirtlar uchun spreyi', 'bottle', 0.1200, NULL, false, true),
    
    -- Electronics Category
    ('CHARGER-USB', 'Phone Charger Cable', 'Phone Charger Cable', 'Зарядный кабель телефона', 'Telefon zaryadlash kabeli', '723456789012', 9.99, 4.00, 25, 5, (SELECT id FROM categories WHERE key = 'electronics'), 'Generic', 'USB charging cable', 'USB charging cable', 'USB зарядный кабель', 'USB zaryadlash kabeli', 'piece', 0.1200, NULL, false, true),
    ('BATTERIES-AA', 'Batteries AA 4-pack', 'Batteries AA 4-pack', 'Батарейки AA 4 штуки', 'Batareyalar AA 4 ta', '723456789013', 4.99, 2.20, 30, 5, (SELECT id FROM categories WHERE key = 'electronics'), 'Duracell', 'Alkaline AA batteries', 'Alkaline AA batteries', 'Щелочные батарейки AA', 'Alkalin AA batareyalar', 'pack', 0.1200, NULL, false, true),
    ('PHONE-CASE', 'Phone Case', 'Phone Case', 'Чехол для телефона', 'Telefon g''ilofi', '723456789014', 14.99, 7.50, 15, 3, (SELECT id FROM categories WHERE key = 'electronics'), 'OtterBox', 'Protective phone case', 'Protective phone case', 'Защитный чехол для телефона', 'Himoyalovchi telefon g''ilofi', 'piece', 0.1200, NULL, false, true),
    ('EARBUDS-WIRED', 'Earbuds', 'Earbuds', 'Наушники', 'Quloqchinlar', '723456789015', 19.99, 10.00, 12, 2, (SELECT id FROM categories WHERE key = 'electronics'), 'Apple', 'Wired earbuds with mic', 'Wired earbuds with mic', 'Проводные наушники с микрофоном', 'Simli quloqchinlar mikrofon bilan', 'piece', 0.1200, NULL, false, true),
    ('POWERBANK-10K', 'Power Bank', 'Power Bank', 'Внешний аккумулятор', 'Tashqi akkumulyator', '723456789016', 24.99, 12.50, 8, 2, (SELECT id FROM categories WHERE key = 'electronics'), 'Anker', 'Portable power bank 10000mAh', 'Portable power bank 10000mAh', 'Портативный внешний аккумулятор 10000мАч', 'Ko''chma tashqi akkumulyator 10000mAh', 'piece', 0.1200, NULL, false, true),
    ('USB-DRIVE-32GB', 'USB Flash Drive', 'USB Flash Drive', 'USB флешка', 'USB flesh disk', '723456789017', 12.99, 6.50, 20, 4, (SELECT id FROM categories WHERE key = 'electronics'), 'SanDisk', '32GB USB flash drive', '32GB USB flash drive', '32ГБ USB флешка', '32GB USB flesh disk', 'piece', 0.1200, NULL, false, true);
